...
// export default function Logo({ withoutBackground }: { withoutBackground?: boolean }) {
//     return (
//         <div className="relative w-24 h-24 flex items-center justify-center">
//             {!withoutBackground && (
//                 <>
//                     <div className="absolute inset-0 bg-[#6b22a8] rounded-l-[25px]"></div>
//                     <div className="absolute inset-0 bg-[#7e22cd] rounded-r-[25px] w-1/2 right-0"></div>
//                 </>
//             )}
